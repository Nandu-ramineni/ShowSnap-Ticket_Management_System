      ...
      schemas: {
        ...
        TheatreOwnerPublic: {
          ...
          properties: {
            ...
            accountStatus: { type: 'string', enum: ['pending', 'active', 'rejected'], example: 'pending' },
        ...
        TheatreOwnerRegisterRequest: {
          type: 'object',
          required: ['email', 'password', 'theatreInfo', 'location'],
          properties: {
            email: { type: 'string', format: 'email', example: 'priya@inoxcinemas.com' },
        ...
        TheatreOwnerUpdateRequest: {
          ...
          properties: {
            ...
            theatreInfo: {
              type: 'object',
              description: 'theatreName is immutable after registration',
              properties: {
