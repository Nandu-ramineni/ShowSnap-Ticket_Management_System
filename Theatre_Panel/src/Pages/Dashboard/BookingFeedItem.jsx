...
export default function BookingFeedItem({ booking, index }) {
    return (
        ...
        >
            <div className={`w-7 h-7 rounded-full flex items-center justify-center shrink-0 mt-0.5 ${booking.status === 'confirmed' ? 'bg-green-500/15' : 'bg-red-500/15'
                }`}>
            ...
            <div className="flex-1 min-w-0">
                <div className="flex items-center justify-between gap-2">
                    ...
                    <p className={`text-sm font-bold shrink-0 ${booking.status === 'confirmed' ? 'text-green-400' : 'text-red-400'}`}>
